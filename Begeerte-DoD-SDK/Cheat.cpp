        ...
        while (isRunning) {
            ...
            */
            ...
            for (int i = 1; i <= EntityList::GetMaxPlayers(); i++) {
                ...
                printf("Entity (%d) | HP: %d | GrowthStage: %d | SavedGrowth: %d | Pos: (%.1f, %.1f, %.1f) | Distance: %.1f\n",
                    i,
                    player->Health,
                    player->GrowthStage,
                    player->SavedGrowth,
                ...
                printf("Entity (%d) | HP: %d | GrowthStage: %d | SavedGrowth: %d | PosLand: (%.1f, %.1f, %.1f) | PosAir: (%.1f, %.1f, %.1f) | Distance: %.1f\n", 
                    i, 
                    player->Health, 
                    player->GrowthStage, 
                    player->SavedGrowth,
                    ...
                    Vector::CreateVec3(player->PositionOnLandX, player->PositionOnLandY, player->PositionOnLandZ).IsZero()
                );
            }
            */
