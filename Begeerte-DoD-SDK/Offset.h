...
namespace Offset {
    namespace LocalPlayerBase {
        static constexpr DWORD64 MODULE_OFFSET = 0x085A4380;
        static const std::vector<DWORD64> OFFSETS{ 0x30, 0x2D0, 0x660, 0x20, 0x0 };
    }
    ...
    namespace EntityList {
        ...
        static constexpr DWORD64 ENTITY_OFFSET_END = 0x1337;   // 实体偏移范围终点
        ...
        static constexpr size_t MAX_ENTITY_COUNT = 200;       // 最大实体数量 (id1 到 id200)
    }
}