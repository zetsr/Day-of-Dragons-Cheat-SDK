...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0849D4D0;
	constexpr int32 AppendString      = 0x029F86E0;
	constexpr int32 GNames            = 0x083F6EC0;
	constexpr int32 GWorld            = 0x085F65E0;
	constexpr int32 ProcessEvent      = 0x02B9C8C0;
