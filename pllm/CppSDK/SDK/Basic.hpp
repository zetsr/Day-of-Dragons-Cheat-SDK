...
namespace Offsets
{
	constexpr int32 GObjects          = 0x084AADD0;
	constexpr int32 AppendString      = 0x02A1EF10;
	constexpr int32 GNames            = 0x084047C0;
	constexpr int32 GWorld            = 0x08603EE0;
	constexpr int32 ProcessEvent      = 0x02BC30F0;
