...
namespace Offsets
{
	constexpr int32 GObjects          = 0x084A58D0;
	constexpr int32 AppendString      = 0x029FD130;
	constexpr int32 GNames            = 0x083FF2C0;
	constexpr int32 GWorld            = 0x085FE9E0;
	constexpr int32 ProcessEvent      = 0x02BA1310;
